    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col overflow-x-hidden">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-28 md:py-40 relative">
        ...
        <span className="relative inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-primary border border-primary/20 bg-primary/10 rounded-full px-4 py-1.5 mb-8">
          <Star className="w-3 h-3 animate-pulse" /> {isMirror ? "Shadow Work & Self-Alignment" : "Master Your Reputation"}
        </span>
          ...
          {[
            {
              ...
              step: "01",
              title: isMirror ? "Nominate your inner circle" : "Nominate your raters",
              desc: isMirror
                ? "Choose up to 20 people who know you best. Friends, family, or mentors. We generate secure, anonymous links so they can share gentle, honest reflections."
                : "Choose up to 20 people who know you best. Colleagues, clients, or managers. We generate secure, anonymous links so they can speak freely.",
            },
            {
              icon: <Eye className="w-5 h-5 text-primary" />,
              step: "02",
              title: isMirror ? "Gather gentle reflections" : "Collect candid honesty",
              desc: isMirror
                ? "Evaluators submit reflections anonymously. Our AI sanitizes responses to remove identifying details while preserving the authentic essence."
                : "Raters submit candid feedback anonymously. Our AI sanitizes responses to remove identifying language while preserving hard truths.",
            },
            {
              icon: <ShieldCheck className="w-5 h-5 text-primary" />,
              step: "03",
              title: isMirror ? "Reveal your true self" : "Receive your growth roadmap",
              desc: isMirror
                ? "Unlock your synthesized report. A gentle, clear reflection of how you are experienced, offering a path for personal alignment and growth."
                : "Unlock your synthesized report. A forensic reputation audit that shows you exactly how you are perceived and provides a clear roadmap for self improvement.",
            },
          ].map((item) => (
            <div
              key={item.step}
      ...
      <section className="px-6 md:px-12 pb-24 max-w-4xl mx-auto w-full">
        <div className="relative bg-card border border-border rounded-3xl p-10 md:p-16 text-center overflow-hidden">
          ...
          <h2 className="relative text-3xl md:text-4xl font-serif font-black tracking-tight mb-4 text-foreground">
            {isMirror ? "Ready to align your growth?" : "Ready to master your reputation?"}
          </h2>
